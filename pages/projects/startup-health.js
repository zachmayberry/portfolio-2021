        ...
        <div className="bg-light min-h-screen w-screen overflow-hidden">
            ...
            <main className="pt-32">
                <div className="relative z-0">
                    <Parallax strength={300} className="h-screen">
                        <div className="text-center">
                            <h1 className="uppercase font-serif font-bold text-6xl">Design. Build. Repeat.</h1>
                            <h2 className="font-bold text-4xl opacity-30 pt-2">StartUp Health</h2>
                        </div>
                        <Background className="pt-52">
                            <Image
                                src={suhImage}
                                alt="SUH"
                            />
